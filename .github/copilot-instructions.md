...
- [x] Scaffold the Project (repo já existente; nenhuma ação necessária)
...
- [x] Create and Run Task (não requerido neste setup)
	Verify that all previous steps have been completed.
...
- [x] Launch the Project (aguardando confirmação do usuário para modo debug)
	Verify that all previous steps have been completed.
